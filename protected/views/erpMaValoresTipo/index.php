...
$('.search-form form').submit(function(){
    $.fn.yiiGridView.update('erp-ma-valores-tipo-grid', {
        data: $(this).serialize()
    });
    return false;
});
...
<h2><?php echo Yii::t('title','ErpMaValoresTipos'); ?></h2>
<hr />
...
array(
            #'header'=>'id_categoria',
            'name'   => 'id_categoria',
            'value'  => 'isset($data->idCategoria->nombre)?$data->idCategoria->nombre:"N/A"',
            'filter' => CHtml::listData(ErpMaValoresTipoCateg::model()->findAll(),'id','nombre'),
            'htmlOptions' => array('style' => 'text-align:center;min-width:20px;')
            ),
array(
            #'header'=>'nombre',
