...
$this->breadcrumbs=array(
	Yii::t('title','ErpMaValoresTipoCategs'),
);
...
$('.search-form form').submit(function(){
    $.fn.yiiGridView.update('erp-ma-valores-tipo-categ-grid', {
        data: $(this).serialize()
    });
    return false;
});
...
<h2><?php echo Yii::t('title','ErpMaValoresTipoCategs'); ?></h2>
<hr />
...
'id' => 'erp-ma-valores-tipo-categ-grid',
